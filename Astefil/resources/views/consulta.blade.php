                ...
                <div class="formulario_consulta">
                    ...
                    <div class="segunda_linea">
                        ...
                        <div class="direccion">
                            ...
                            <input type="text" class="form-control" id="direccion_cliente" placeholder="Dirección" required>
                        </div>

                        <div class="localidad">
                            <label for="localidad_cliente" class="form-label">Localidad*</label>
                            <input type="text" class="form-control" id="localidad_cliente" placeholder="Localidad" required>
                        </div>
                    ...
                    <div class="tercera_linea">
                        ...
                        <div class="mail">
                            <label for="mail_cliente" class="form-label">Dirección de E-Mail*</label>
                            <input type="text" class="form-control" id="mail_cliente" placeholder="E-Mail" required>  
                        </div>
                    ...
                    <div class="quinta_linea">
                        ...
                        <div class="asunto">
                            <label for="asunto_cliente" class="form-label">Escriba el asunto de su consulta*</label>
                            <textarea class="form-control" id="asunto_cliente"></textarea>
                        </div>
